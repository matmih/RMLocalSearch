 ...
 * @author matej
 */
public class GeneratingTesting {
    ...
    //testing for different memory range
          for(int numTrees = 1;numTrees<7;numTrees++){
              
              if(numTrees==3 || numTrees == 5)
                  continue;
              
              appset.numTreesinForest = numTrees;
              ...
              for(int alg = 0;alg<3;alg++){
                  ...
                  if(alg == 0 && numTrees == 1){
                      ...
                      appset.generatingModelType = 0;
                      algorName = "GeneratingPCT"+appset.numTreesinForest+"T";
                        
                      appset.outputName = output+"GeneratingPCT1T_"+appset.workRSSize+"_"+appset.maxRSSize+".rr";
                  }
                  else if(alg == 0 && numTrees>1)
                      continue;
                  else if(alg == 1)
                  {
                      appset.SupplementPredictiveTreeType = 0;
                     appset.numSupplementTrees = 0;
                     appset.generatingModelType = 1;
                     appset.outputName = output+"GeneratingSub"+appset.numTreesinForest+"T_"+appset.workRSSize+"_"+appset.maxRSSize+".rr";
                     algorName = "GeneratingSub"+appset.numTreesinForest+"T";
                  }
                  else if(alg == 2){
                      appset.SupplementPredictiveTreeType = 1;
                      appset.numSupplementTrees = 0;
                      appset.generatingModelType = 2;
                      appset.outputName = output+"GeneratingET"+appset.numTreesinForest+"T_"+appset.workRSSize+"_"+appset.maxRSSize+".rr";
                      algorName = "GeneratingET"+appset.numTreesinForest+"T";
                    }
                  else if(alg == 3){
                      appset.SupplementPredictiveTreeType = 2;
                      appset.numSupplementTrees = 0;
                      appset.generatingModelType = 3;
                      appset.outputName = output+"GeneratingROS"+appset.numTreesinForest+"T_"+appset.workRSSize+"_"+appset.maxRSSize+".rr";
                      algorName = "GeneratingROS"+appset.numTreesinForest+"T";
                  }      
